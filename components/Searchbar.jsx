...
export const Searchbar = () => {
  ...
  return (
    <div className="w-full pt-20 -mt-3 md:-mt-0 pb-60 md:pb-40">
      <div className="input-group relative flex flex-nowrap justify-center min-w-0 mb-4 rounded">
        <form className="flex" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            className="relative px-4 py-1 ml-4 border-2 border-blue-400 text-blue-400 md:font-medium text-xs leading-tight uppercase rounded-full hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
