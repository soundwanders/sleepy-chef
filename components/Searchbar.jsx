          ...
          <div className="input-group relative flex flex-nowrap justify-center min-w-0 mb-4 rounded px-4 md:px-0">
            ...
            >
              ...
              <button 
                ...
                tabIndex="0"
              >
                <span id="search-icon" className="input-group-text flex flex items-center md:px-3.5 py-1 cursor-pointer text-base font-normal text-gray-600 dark:text-gray-200 text-center whitespace-nowrap rounded">
