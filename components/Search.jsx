...
export default function Search() {
  return (
    <form className="max-w-4xl mx-auto">
      <div className="w-5/6 md:w-full mx-auto md:mx-0 flex justify-center">
        <div className="w-full pt-20 pb-40">
          <div className="input-group relative flex flex-nowrap justify-center items-stretch w-full mb-4 rounded">
            ...
            <span className="input-group-text flex flex items-center px-3 py-1.5 text-base font-normal text-gray-500 dark:text-gray-200 text-center whitespace-nowrap rounded" id="search-icon">
