...
export const RemoveLine = () => (
  <svg className="fill-current w-4 h-auto cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
...
export const AddLine = () => (
  <svg className="fill-current w-5 h-auto cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
export const ClearAll = () => (
  <svg className="fill-current w-5 h-auto cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
