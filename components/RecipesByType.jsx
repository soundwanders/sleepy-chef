...
export default function RecipesByType({ allRecipes, mainTypes }) {
  const highlightColor = "#60a5fa";
  const defaultColor = "bg-blue-300";
  const recipeColors = {
    beef: "bg-orange-200",
          ...
          allRecipes.map(recipe => (
            ...
            >
              <div className="min-h-0 bg-neutral-100 dark:bg-gradient-to-b from-neutral-800 to-neutral-900 shadow-md rounded-lg overflow-hidden transform hover:scale-101">  
                ...
                <div className="p-8">
                  <div className="grid grid-cols-2 gap-4 pb-4 border-b border-slate-500 -mt-3">
