    ...
    <div className="w-full md:w-1/3 py-2 mr-6 md:mr-8">
      <div className="input-group relative flex flex-nowrap justify-end items-stretch w-full rounded">
        <form className="flex" onSubmit={handleSubmit}>
          <input
            className="form-control relative flex-auto min-w-0 w-full px-2 md:px-6 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-gray-300 border-solid rounded-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"  
            type="text"
            aria-label="Search" 
